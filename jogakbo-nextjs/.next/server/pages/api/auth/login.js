...
module.exports = __webpack_require__("6U0C");
...
/* harmony default export */ __webpack_exports__["default"] = (async function (req, res) {
  ...
  if (myAddress !== "0x00") {
    const token = Object(jsonwebtoken__WEBPACK_IMPORTED_MODULE_0__["sign"])({
      exp: Math.floor(Date.now() / 1000) + 60 * 60 * 24 * 30,
      // 30 days
      address: myAddress
    }, secret);
    const serialised = Object(cookie__WEBPACK_IMPORTED_MODULE_1__["serialize"])("OursiteJWT", token, {
      httpOnly: true,
      secure: true,
      sameSite: "strict",
      maxAge: 60 * 60 * 24 * 30,
